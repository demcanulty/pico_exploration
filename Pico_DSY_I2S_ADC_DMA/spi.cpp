...
void fill_buffer()
{
    ...
    {
        random_data[i] = (float)board_millis();
        u32_random_data[i] = board_millis();
    }
}
...
void init_spi()
{
    ...
    channel_config_set_dreq(&spi_dma_cfg, spi_get_dreq(SPI_PORT, true));    // DREQ = ADC FIFO Data Request
    ...
    dma_channel_configure(
        ...
        &u32_random_data,               // Source pointer (ADC FIFO)
...
void spi_dma_transfer( int16_t * this_buff, u32 buff_size_bytes)
{
    fill_buffer();
    ...
    dma_channel_configure(
        ...
        buff_size_bytes,        // Number of transfers
