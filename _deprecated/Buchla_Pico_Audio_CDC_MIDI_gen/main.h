...
#define QUAD_PAN_ATTENUATE  1
#define QUAD_PAN_ROTATE     2
#define QUAD_PAN_X_LOC      4
#define QUAD_PAN_Y_LOC      5



#define TAP_BAND_DTIME_MS  0
#define TAP_BAND_FEEDBACK  1
#define TAP_BAND_FREQ      2
#define TAP_BAND_Q         3
