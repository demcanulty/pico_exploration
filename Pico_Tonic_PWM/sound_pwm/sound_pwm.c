...
//****************************************************************
//***  RP2350  DATASHEET SECTION  4.5 - Peripheral -> PWM  *******
//****************************************************************
...
void sound_pwm_init(uint16_t audio_pin, uint32_t sample_rate)
{
    ...
    //***  GET CORRESPONDING PWM "SLICE" (ie PWM CONTROLLER) ***
...
{
    pwm_set_chan_level(slice_num, pwm_channel,pwm_duty);
}
